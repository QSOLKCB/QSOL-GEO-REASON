...
qsol_first_observation() {
  (
    ...
    for qsol_loader_var in ${!LD_@} ${!DYLD_@} ${!_RLD_@} ${!LDR_@}; do
      unset "$qsol_loader_var"
    done
    unset GLIBC_TUNABLES LIBPATH SHLIB_PATH
